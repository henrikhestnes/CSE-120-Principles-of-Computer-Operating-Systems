 ...
 * you use Printf, rather than printf, as the former immediately flushes
 * buffered output, thus avoiding the potential of unusual sequences of
 * combined output from multiple processes (you may wish to experiment with
 * trying both printf and Printf to see this behavior).
 *
